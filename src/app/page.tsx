    ...
    <>
      <section className="border-b border-stone-300 bg-white">
        <div className="container-page py-16 sm:py-24">
          <div className="max-w-3xl">
            ...
            <h1 className="mt-5 text-40p font-black tracking-tight text-slateCharcoal sm:text-48p">
      ...
      <section className="container-page py-16 sm:py-20">
        ...
        <ol className="mt-12 grid gap-px bg-stone-300 lg:grid-cols-3">
          {STEPS.map((step, index) => (
            <li key={step.title} className="bg-stone-100 px-6 py-9">
              <span className="spec-num text-40p font-black leading-none text-hardie-700">
                {String(index + 1).padStart(2, "0")}
              </span>
              <h3 className="mt-5 text-20p font-black tracking-tight text-slateCharcoal">{step.title}</h3>
      ...
      <section className="border-y border-stone-300 bg-white">
        <div className="container-page py-16 sm:py-20">
          ...
          <h2 className="mt-2.5 max-w-2xl text-32p font-black tracking-tight text-slateCharcoal sm:text-40p">
            We answer these before you sign anything
          </h2>
          <div className="mt-12 grid gap-x-12 gap-y-10 sm:grid-cols-2">
            {ANSWERS.map((item) => (
              <div key={item.question} className="border-t border-stone-300 pt-5">
                <h3 className="text-20p font-black tracking-tight text-slateCharcoal">
      ...
      <section className="container-page py-16 sm:py-20">
        <div className="bg-hardie-800 px-8 py-16 text-white sm:px-14">
          ...
          <p className="mt-4 max-w-2xl text-[15px] leading-relaxed text-stone-200">
