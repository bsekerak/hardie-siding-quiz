  ...
  return (
    ...
    >
      <motion.div
        ...
        className="w-full max-w-lg rounded-2xl bg-white p-6 shadow-lifted sm:p-8"
      >
        ...
        {saved ? (
          <div className="mt-5">
            <div className="flex gap-3 rounded-xl bg-hardie-50 p-4">
          ...
          <div className="mt-5">
            ...
            <input
              ...
              className="mt-2 w-full rounded-xl border border-stone-200 bg-white px-4 py-3 text-[15px] text-slateCharcoal placeholder:text-stone-400 focus:border-hardie-500"
            />
            {touched && !valid ? (
